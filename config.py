...
flexangle=torch.tensor([  0.0000,  90,  135,  90,  90,  135,  90,
         ...
         0.0000,   0.0000,   0.0000,   0.0000,   0.0000],dtype=torch.float32)/180*3.14
extenangle=torch.tensor([ 0.0000, 45.2844,  10, 45,  45.2844,  10, 45,
         45.2844,  10, 45,  45.2844,  10, 45, 45.2844,  10, 45,
...
# #75 percentage
# abangle=torch.tensor([ 0.0000,  8.6279,  0.0000,  0.0000,  6.5669,  0.0000,  0.0000, 24.2241,
#          0.0000,  0.0000, 17.4524,  0.0000,  0.0000, 14.7449,  0.0000,  0.0000,
#          0.0000,  0.0000,  0.0000,  0.0000,  0.0000], dtype=torch.float32)/180*3.14
# twangle=torch.tensor([ 0.0000, 10.2164,  0.0000,  0.0000, 10.3942,  0.0000,  0.0000, 25.1173,
#          0.0000,  0.0000, 23.3490,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,
#          0.0000,  0.0000,  0.0000,  0.0000,  0.0000], dtype=torch.float32)/180*3.14
# flexangle=torch.tensor([ 0.0000, 37.6211, 43.8612,  8.0502, 42.5282, 80.4423, 15.9037, 52.5532,
#         81.6151, 26.4386, 53.5898, 76.6250, 23.7077, 18.2974, 13.5132,  0.0000,
#          0.0000,  0.0000,  0.0000,  0.0000,  0.0000], dtype=torch.float32)/180*3.14
# extenangle=torch.tensor([ 0.0000,  0.0000,  0.0000,  6.3684,  0.0000,  0.0000,  4.5631,  0.0000,
#          0.0000,  8.7795,  0.0000,  0.0000,  5.6571, 13.7024, 36.2447, 14.7870,
#          0.0000,  0.0000,  0.0000,  0.0000,  0.0000], dtype=torch.float32)/180*3.14
